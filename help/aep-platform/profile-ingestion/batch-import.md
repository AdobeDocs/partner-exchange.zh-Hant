...
AEP可從一般檔案（例如parquet）或符合[!UICONTROL Experience Data Model] (XDM)登入中已知結構描述的資料中，擷取包含設定檔資料的批次檔案。
...
在本教學課程中，我們將使用JSON作為格式。 在[開發人員指南中找到更多格式範例](https://www.adobe.io/apis/experienceplatform/home/data-ingestion/data-ingestion-services.html#!api-specification/markdown/narrative/technical_overview/ingest_architectural_overview/batch_data_ingestion_developer_guide.md)
...
* [批次擷取概觀](https://www.adobe.io/apis/experienceplatform/home/data-ingestion/data-ingestion-services.html#!api-specification/markdown/narrative/technical_overview/ingest_architectural_overview/ingest_architectural_overview.md)
